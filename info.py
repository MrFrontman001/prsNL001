...
# Bot information
API_ID = environ.get('API_ID', '19822115')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '7404299810 7782885132')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002600618270').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002652695292')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002377246826')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/filmysupport')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/filmyxupdates')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/FilmyWabXGroup')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002593263685")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://filmywabx02.onrender.com/")
if len(URL) == 0:
...
STICKERS = [sticker for sticker in environ.get('STICKERS', 'CAACAgUAAxkBAAIpZ2iCgI1_ogxrD5k_kVRom1T-cUghAALwGwAC1Mw5V_8vqAhQJ7oWHgQ CAACAgUAAxkBAAIpa2iCgJw-pDutxwOUwTOerBgzD74EAAIWGgACItbQVnpzwmZRO73oHgQ CAACAgUAAxkBAAIpb2iCgKRdxLYPGeyx-Oqjkpxe8o4KAALIFwACpohBV5JM3q552z0RHgQ').split()]  # Multiple sticker can be used separated by space, use @idstickerbot for get sticker id
...
UPI_ID = environ.get("UPI_ID", "941482225@fryl")
if len(UPI_ID) == 0:
    logger.info('UPI_ID is empty')
UPI_NAME = environ.get("UPI_NAME", "Thanos™") # add your UPI account name
if len(UPI_NAME) == 0:
